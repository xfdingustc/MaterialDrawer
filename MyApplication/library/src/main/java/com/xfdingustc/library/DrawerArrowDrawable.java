package com.xfdingustc.library;
...
public abstract class DrawerArrowDrawable extends Drawable {
  ...
  public DrawerArrowDrawable(Context context) {
    ...
    this.mPaint.setColor(context.getResources().getColor(R.color.material_drawer_color));
    this.mSize = context.getResources().getDimensionPixelSize(R.dimen.material_drawer_drawableSize);
    this.mBarSize = context.getResources().getDimensionPixelSize(R.dimen.material_drawer_barSize);
    this.mTopBottomArrowSize = context.getResources().getDimensionPixelSize(R.dimen.material_drawer_topBottomBarArrowSize);
    this.mBarThickness = context.getResources().getDimensionPixelSize(R.dimen.material_drawer_thickness);
    this.mBarGap = context.getResources().getDimensionPixelSize(R.dimen.material_drawer_gapBetweenBars);
    this.mMiddleArrowSize = context.getResources().getDimensionPixelSize(R.dimen.material_drawer_middleBarArrowSize);
